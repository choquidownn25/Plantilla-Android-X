...
public abstract class BaseActivity extends Activity implements ServiceConnection {
    ...
    private Messenger messenger = new Messenger(new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SinchServices.MESSAGE_PERMISSIONS_NEEDED:
                    Bundle bundle = msg.getData();
                    String requiredPermission = bundle.getString(SinchServices.REQUIRED_PERMISSION);
    ...
    private void bindService() {
        Intent serviceIntent = new Intent(this, SinchServices.class);
        serviceIntent.putExtra(SinchServices.MESSENGER, messenger);
